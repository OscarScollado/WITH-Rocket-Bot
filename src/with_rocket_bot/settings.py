...
TRANSITIONS_MODULE = "with_rocket_bot.transitions"
...
# error messages.
DEFAULT_STATE = "with_rocket_bot.states.WithRocketBotState"
    ...
    PLATFORMS.append(
        {
            ...
            "class": "with_rocket_bot.TelegramMedia.TelegramMedia",
            "settings": {
...
# URL of the API to test the application.
TEST_API_URL = getenv("TEST_API_URL")

# URL of the API to use in the application in production mode.
...
USERS_READING_BUBBLE_START = 1.0
...
# The webserver's debug mode.
DEBUG = getenv("DEBUG")

# Whether to work with the test video or the API video.
DEV = True if getenv("DEV") == "yes" else False
